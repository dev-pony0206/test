            ...
            <form class="font-display space-y-4 > * w-80" @submit.prevent="submit">
                ...
                <div class="relative">
                    <div class="flex justify-center">
                        <input type="file" class="w-36 h-36 rounded-full border opacity-0 z-10" @change="chooseFile"
                            ref="file" />
                    </div>
                ...
                <input class="block w-full h-10 rounded-xl px-2" type="text" name="name" v-model="signupUser.username" />
                ...
                <label for="password" class="text-white text-2xl px-2">Password</label>
                <input class="block w-full h-10 rounded-xl px-2" type="password" name="password"
